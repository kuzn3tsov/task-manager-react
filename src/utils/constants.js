...
export const DICT = {
    en: {
        ...
        testSent: 'Test message sent endpoint. Message needs service running to actually be sent!',
    ...
    hr: {
        ...
        testSent: 'Test poruka poslana endpoitn! Potrebno je konfigurirati servis za slanje poiruke!',
